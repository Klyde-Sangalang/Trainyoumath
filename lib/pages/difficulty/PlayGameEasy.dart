...
class PlayGameEasy extends StatefulWidget {
  const PlayGameEasy({super.key});

  @override
  State<PlayGameEasy> createState() => _PlayGameEasyState();
}
...
class _PlayGameEasyState extends State<PlayGameEasy> {
  static const maxSeconds = 120.0;
