...
class PlayGameHard extends StatefulWidget {
  const PlayGameHard({super.key});

  @override
  State<PlayGameHard> createState() => _PlayGameHardState();
}



class _PlayGameHardState extends State<PlayGameHard> {
  static const maxSeconds = 60.0;
